...
pass:q[Some clauses, such as `WHERE`, `WHEN`, and `HAVING`, require values to be interpreted as Boolean values.]
...
| a | b | a AND b | a OR b | NOT a .4+ |
| :-: | :-: | :-: | :-: | :-: |
| TRUE | TRUE | TRUE | TRUE .4+ | FALSE |
| FALSE | FALSE | TRUE | NULL | NULL |
| TRUE | MISSING | MISSING | TRUE .4+ | FALSE |
| TRUE | FALSE | TRUE .4+ | TRUE | FALSE |
| FALSE | FALSE | NULL | FALSE | NULL |
| MISSING | FALSE | MISSING .4+ | NULL | TRUE |
| NULL | TRUE .4+ | NULL | FALSE | FALSE |
| NULL | NULL | NULL | NULL | MISSING |
| MISSING | NULL .4+ | MISSING | TRUE | MISSING |
| TRUE .4+ | MISSING | FALSE | FALSE | MISSING |
| NULL | MISSING | NULL | MISSING | MISSING |
