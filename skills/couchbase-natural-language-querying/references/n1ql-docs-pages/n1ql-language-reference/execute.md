...
![Syntax diagram: refer to source code listing](../../assets/images/n1ql-language-reference/execute.png)
...
**💡 TIP**\
If the name of the prepared statement contains hyphens, wrap the entire name in backticks (`{backtick}`) or double quotation marks (`"`).
...
For more information, see [Automatic Reprepare on Index Changes](n1ql-language-reference/prepare.adoc#auto-reprepare-index).
...
See [n1ql:n1ql-manage/query-settings.adoc](n1ql:n1ql-manage/query-settings.adoc) for more information.
...
* For information on preparing a statement for execution, refer to [PREPARE](n1ql-language-reference/prepare.adoc).
