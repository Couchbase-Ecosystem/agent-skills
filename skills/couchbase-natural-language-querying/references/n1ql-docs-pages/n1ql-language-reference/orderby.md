...
* **expr**\
[Required] The identifier or expression by which to order the query results.
...
<a name="Ex1"></a>**List cities in descending order and then landmarks in ascending order**
...
<a name="Ex2"></a>**List the names of hotels and landmarks resulting from a UNION query**
