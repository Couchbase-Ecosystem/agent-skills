...
Integers, or any valid [expressions](n1ql-language-reference/index.adoc) which evaluate to integers, that are used to compare.
...
* **int_value**\
An integer, or any valid [expression](n1ql-language-reference/index.adoc) which evaluates to an integer, that contains the target bit or bits to clear.
* **positions**\
...
* **int_value**\
An integer, or any valid [expression](n1ql-language-reference/index.adoc) which evaluates to an integer, that contains the target bits to reverse.
...
* **int_value**\
An integer, or any valid [expression](n1ql-language-reference/index.adoc) which evaluates to an integer, that contains the target bit or bits to set.
* **positions**\
...
* **int_value**\
An integer, or any valid [expression](n1ql-language-reference/index.adoc) which evaluates to an integer, that contains the target bit or bits to shift.
* **shift_amount**\
An integer, or any valid [expression](n1ql-language-reference/index.adoc) which evaluates to an integer, that contains the number of bits to shift.

  A positive (+) number means this is a LEFT shift.

  A negative (-) number means this is a RIGHT shift.
* **rotate**\
[Optional; FALSE by default] A boolean, or any valid [expression](n1ql-language-reference/index.adoc) which evaluates to a boolean, where:
...
| Input | Shift | Result of Logical Shift<br> (Rotate FALSE) |
| --- | --- | --- | --- |
| Result of Circular Shift<br> (Rotate TRUE) | 6 (0000 0110) | 4 | 96 (0110 0000) |
| 96 (0110 0000) | 6 (0000 0110) | 3 | 48 (0011 0000) |
| 48 (0011 0000) | 6 (0000 0110) | 2 | 24 (0001 1000) |
| 24 (0001 1000) | 6 (0000 0110) | 1 | 12 (0000 1100) |
| 12 (0000 1100) | **6 (0000 0110)** | **0** | **6 (0000 0110)** |
| **6 (0000 0110)** | 6 (0000 0110) | -1 | 3 (0000 0011) |
| 3 (0000 0011) | 6 (0000 0110) | -2 | 1 (0000 0001) |
| -9223372036854775807 (1000 0000 \... 0000 0001) | 6 (0000 0110) | -3 | 0 (0000 0000) |
| -4611686018427387904 (1100 0000 \... 0000 0000) | 6 (0000 0110) | -4 | 0 (0000 0000) |
...
This function has a synonym [ISBITSET()](#isbitset--see-bittest).
...
* **int_value**\
An integer, or any valid [expression](n1ql-language-reference/index.adoc) which evaluates to an integer, that contains the target bit or bits to test.
* **positions**\
An integer or an array of integers specifying the position or positions to be tested.
* **all_set**\
[Optional; FALSE by default] A boolean, or any valid [expression](n1ql-language-reference/index.adoc) which evaluates to a boolean.
...
Synonym of [BITTEST()](#bittest-int_value-positions--all_set).
