...
The [ALTER VECTOR INDEX](n1ql-language-reference/altervectorindex.adoc) statement is a synonym for the ALTER INDEX statement.
...
![Syntax diagram: see source code listing](../../assets/images/n1ql-language-reference/alter-index.png)
...
!["The Indexes tab showing def_inventory_airport_faa on 192.168.10.10"](../../assets/images/alter-index_servers_step1.png)
...
!["The Indexes tab showing def_inventory_airport_faa on 192.168.10.11"](../../assets/images/alter-index_servers_step2.png)
