...
| **GitHub Copilot CLI**  | `copilot plugin marketplace add Couchbase-Ecosystem/agent-skills`, then `copilot plugin install couchbase@couchbase-plugins` (restart to activate the MCP server)                                                                                                                                                                                         |
