...
To set up the MCP connection, see the `couchbase-mcp-setup` skill or the [MCP server docs](https://github.com/Couchbase-Ecosystem/mcp-server-couchbase#readme). Required env: `CB_CONNECTION_STRING`, `CB_USERNAME`, `CB_PASSWORD`, `CB_BUCKET_NAME`.
